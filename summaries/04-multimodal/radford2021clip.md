...
Citekey `radford2021clip`. Prose here is CC BY 4.0 and the code in this repository is MIT; [`COPYRIGHT.md`](../../COPYRIGHT.md) is the authoritative path-to-licence map, and the `summaries/LICENSE` marker repeats it for this directory.
